...
import re
req=requests.get("https://www.espncricinfo.com/records/decade/bowling-most-wickets-career/2020s-202/test-matches-1")
...
print(data)
data.to_csv(r'D:\python\bowler_test.csv',index=False,header=True)