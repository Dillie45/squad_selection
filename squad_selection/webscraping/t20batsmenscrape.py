...
import re
req=requests.get("https://www.espncricinfo.com/records/decade/batting-most-runs-career/2020s-202/twenty20-internationals-3")
...
print(data)
#data.to_csv(r'D:\python\batsmen_t20.csv',index=False,header=True)