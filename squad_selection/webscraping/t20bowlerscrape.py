...
import re
req=requests.get("https://www.espncricinfo.com/records/decade/bowling-most-wickets-career/2020s-202/twenty20-internationals-3")
...
print(data)
data.to_csv(r'D:\python\bowler_t20.csv',index=False,header=True)